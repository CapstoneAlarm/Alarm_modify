...
import za.co.neilson.alarm.Alarm.Howto;
...
public class Database extends SQLiteOpenHelper {
	...
	public static final String COLUMN_ALARM_HOWTO = "alarm_difficulty";
	...
	public static long create(Alarm alarm) {
		...
		cv.put(COLUMN_ALARM_HOWTO, alarm.getHowto().ordinal());
	...
	public static Alarm getAlarm(int id) {
		...
		if(c.moveToFirst()){
			...
			alarm.setHowto(Howto.values()[c.getInt(5)]);
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( " 
				...
				+ COLUMN_ALARM_HOWTO + " INTEGER NOT NULL, "
	...
	public static List<Alarm> getAll() {
		...
		if (cursor.moveToFirst()) {
			...
			do {
				...
				alarm.setHowto(Howto.values()[cursor.getInt(4)]);
